...
console.log("------------------------------------------------------------------------------------------------")
console.log("In example3/Main.js, before call to createSagaMiddleware()")
const sagaMiddleware = createSagaMiddleware()

// Create the Redux Store, and connect the saga middleware to it.
console.log("In example3/Main.js, before call to createStore()")
...
console.log("In example3/Main.js, before call to run(aSaga)")
sagaMiddleware.run(rootSaga)
console.log("In example3/Main.js, after call to run(aSaga)")
